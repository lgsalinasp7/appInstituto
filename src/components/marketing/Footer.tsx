            ...
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400 text-sm">
                            <li><Link href="mailto:soporte@kaledsoft.tech" className="hover:text-cyan-400 transition-colors duration-300">Centro de Ayuda</Link></li>
                            <li><Link href="mailto:ventas@kaledsoft.tech?subject=Consulta%20sobre%20planes" className="hover:text-cyan-400 transition-colors duration-300">Hablar con Ventas</Link></li>
                            <li><Link href="https://wa.me/573001234567?text=Hola%2C%20me%20interesa%20KaledSoft" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors duration-300">WhatsApp</Link></li>
                            <li><Link href="#" className="hover:text-cyan-400 transition-colors duration-300">Casos de Éxito</Link></li>
                            <li><Link href="#" className="hover:text-cyan-400 transition-colors duration-300">Términos y Condiciones</Link></li>
                        </ul>
                    </div>
