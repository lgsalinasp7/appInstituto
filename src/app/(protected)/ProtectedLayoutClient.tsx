  ...
  return (
    <AuthGuard>
      <div className={cn(
        ...
        useAcademiaShell ? "academy-shell-dark" : isDark ? "bg-slate-950 text-slate-200" : "bg-white text-slate-900"
      )}>
        ...
        <div className="flex-1 flex flex-col min-w-0 lg:ml-[var(--academia-sidebar-width,18rem)] relative z-10">
          ...
          >
            ...
            <div className={cn("flex items-center gap-4", useAcademiaShell ? "ml-auto" : "ml-6")}>
