...
export const metadata: Metadata = {
    title: "Desarrollo de Software y Soluciones de IA en Colombia",
    ...
    keywords: ["Desarrollo de software Colombia", "Empresa de IA Colombia", "SaaS Factory Latam", "Automatización de procesos IA", "KaledSoft Desarrollo"],
    alternates: {
