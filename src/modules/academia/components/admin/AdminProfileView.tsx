...
export function AdminProfileView({ data }: { data: AdminProfileData }) {
    ...
    >
      <motion.section variants={fadeUp}>
        ...
        <p className="text-slate-500 text-sm">
          Información de tu cuenta como administrador de KaledAcademy.
        </p>
      </motion.section>
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-2">
                <div
                  className="px-3 py-1 rounded-lg text-sm font-medium border border-white/[0.08]"
        ...
        <motion.div variants={fadeUp} className="lg:col-span-8 space-y-5">
          <section className="academy-card-dark rounded-2xl p-5 sm:p-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              />
              <MetricCard
                value={String(data.cohortsCount)}
                label="Cohortes"
