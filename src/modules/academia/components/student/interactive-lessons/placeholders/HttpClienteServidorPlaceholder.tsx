...
export function HttpClienteServidorPlaceholder(_props: InteractiveLessonBaseProps) {
  return (
    <div className="rounded-xl border border-white/[0.08] bg-slate-950/80 p-12 text-center">
      <p className="text-[14px] font-medium text-slate-300">Cliente ↔ servidor (HTTP)</p>
