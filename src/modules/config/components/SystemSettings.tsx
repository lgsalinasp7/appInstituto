            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            type="number"
                            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:border-blue-500 focus:outline-none font-bold text-lg"
                            value={monthlyGoal}
                            onChange={(e) => setMonthlyGoal(Number(e.target.value))}
                        />
                        <p className="mt-2 text-xs text-gray-400 italic">
                            Este valor se utilizará en el Dashboard para calcular el progreso porcentual.
                        </p>
                    </div>
                </div>
            </div>
